    ...
    pub async fn create_order(
        ...
        let order_id = TextbookRepo::insert_order(
            ...
            &super::repo::InsertOrderParams {
                ...
                // 사용자 주문은 이메일 필수. Option<&str> 컬럼에 맞춰 Some 으로 래핑.
...
fn language_display_name(lang: &TextbookLanguage) -> String {
    match lang {
        ...
        TextbookLanguage::EsEs => "스페인어(스페인)",
        TextbookLanguage::Pt => "포르투갈어",
        TextbookLanguage::PtPt => "포르투갈어(포르투갈)",
        TextbookLanguage::Fr => "프랑스어",
        TextbookLanguage::De => "독일어",
        TextbookLanguage::It => "이탈리아어",
        TextbookLanguage::Pl => "폴란드어",
        TextbookLanguage::Uk => "우크라이나어",
        TextbookLanguage::Tr => "터키어",
        TextbookLanguage::Hi => "힌디어",
        TextbookLanguage::Ne => "네팔어",
        TextbookLanguage::Si => "싱할라어",
        TextbookLanguage::Bn => "벵골어",
        TextbookLanguage::Km => "크메르어",
        TextbookLanguage::Lo => "라오어",
        TextbookLanguage::Uz => "우즈베크어",
        TextbookLanguage::Kk => "카자흐어",
        TextbookLanguage::Ky => "키르기스어",
        TextbookLanguage::Tg => "타지크어",
        TextbookLanguage::Tl => "필리핀어",
        TextbookLanguage::Ar => "아랍어",
        TextbookLanguage::Fa => "페르시아어",
...
pub(crate) fn catalog_languages() -> Vec<(TextbookLanguage, &'static str, &'static str, bool, bool)>
{
    ...
    vec![
        ...
        (TextbookLanguage::EsEs, "스페인어(스페인)", "Spanish (Spain)", true, false),
        (TextbookLanguage::Pt, "포르투갈어", "Portuguese", true, false),
        (TextbookLanguage::PtPt, "포르투갈어(포르투갈)", "Portuguese (Portugal)", true, false),
        ...
        (TextbookLanguage::Uk, "우크라이나어", "Ukrainian", true, false),
