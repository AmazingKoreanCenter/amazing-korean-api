...
use super::handler::{
    ...
    admin_bulk_create_study_tasks, admin_create_study_task, admin_list_studies,
    admin_list_study_tasks, admin_update_study, admin_update_study_task,
};
...
pub fn admin_study_router() -> Router<AppState> {
    Router::new()
        ...
        .route("/tasks/bulk", post(admin_bulk_create_study_tasks))
