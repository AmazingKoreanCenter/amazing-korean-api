...
use super::handler::{
    ...
    admin_update_video, admin_bulk_update_video_tags, admin_update_video_tags, create_video_handler,
    get_vimeo_preview_handler, create_vimeo_upload_ticket_handler,
};
...
pub fn admin_video_router() -> Router<AppState> {
    Router::new()
        ...
        .route("/vimeo/preview", get(get_vimeo_preview_handler))
        .route("/vimeo/upload-ticket", post(create_vimeo_upload_ticket_handler))
        // 전체 통계 대시보드
