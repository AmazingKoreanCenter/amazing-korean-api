...
- [3. 공통 규칙 (전역 컨벤션)](#3-공통-규칙-전역-컨벤션)
  - [3.1 시간/타임존](#31-시간타임존)
  - [3.2 네이밍 & 스키마 규칙](#32-네이밍--스키마-규칙-요약)
...
- [4. 데이터 모델 개요 (요약)](#4-데이터-모델-개요-요약)
  ...
  - [4.2 비디오 도메인 (VIDEOS)](#42-비디오-도메인-videos)
  - [4.3 학습 도메인 (STUDY)](#43-학습-도메인-study)
  - [4.4 강의 도메인 (LESSONS)](#44-강의-도메인-lessons)
  - [4.5 관리자 도메인 (ADMIN)](#45-관리자-도메인-admin)
  - [4.6 결제 도메인 (PAYMENT/TICKET)](#46-결제-도메인-paymentticket)

- [5. 기능 & API 로드맵 (Phase / 화면 / 엔드포인트 / 상태 / DoD)](#5-기능--api-로드맵-phase--화면--엔드포인트--상태--dod)
  - [5.0 Phase 로드맵 체크박스 범례](#50-phase-로드맵-체크박스-범례)
  - [5.1 Phase 0 — health](#51-phase-0--health-)
  - [5.2 Phase 1 — user](#52-phase-1--user-)
  - [5.3 Phase 2 — auth](#53-phase-2--auth-)
  - [5.4 Phase 3 — videos](#54-phase-3--videos-)
  - [5.5 Phase 4 — study](#55-phase-4--study-)
  - [5.6 Phase 5 — lessons](#56-phase-5--lessons-)
  - [5.7 Phase 6 — admin](#57-phase-6--admin-)

- [6. 프론트엔드 구조 & 규칙](#6-프론트엔드-구조--규칙)
  - [6.1 프론트엔드 스택 & 기본 원칙](#61-프론트엔드-스택--기본-원칙)
  - [6.2 디렉토리 구조](#62-디렉토리-구조)
  - [6.3 라우팅 규칙](#63-라우팅-규칙)
  - [6.4 상태 관리](#64-상태-관리)
  - [6.5 UI 컴포넌트 패턴](#65-ui-컴포넌트-패턴)

- [7. 작업 방식 / 엔지니어링 가이드 (요약)](#7-작업-방식--엔지니어링-가이드-요약)
  - [7.1 작업 원칙](#71-작업-원칙)
  - [7.2 레이어링 (Handler → Service → Repo)](#72-레이어링-handler--service--repo)
  - [7.3 DTO & Validation](#73-dto--validation)
  - [7.4 파일 구조 (백엔드)](#74-파일-구조-백엔드)
  - [7.5 트랜잭션 & 멱등성](#75-트랜잭션--멱등성)
  - [7.6 테스트 & 검증](#76-테스트--검증)
