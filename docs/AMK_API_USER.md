...
#### 5.2-3 : `POST /users/me` | `PUT /users/me` (내 정보 수정)
> `PUT /users/me`는 `POST /users/me`의 별칭(alias)으로, 동일한 핸들러를 공유한다.
- **성공 → 200 OK(또는 204)**
